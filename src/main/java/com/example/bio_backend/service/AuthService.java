...
import com.example.bio_backend.exception.CompteSuspenduException;
...
public class AuthService {
    ...
    public AuthResponse connecter(LoginRequest requete) {
        ...
        // Module Suspension de compte (2026-09-24) : verifie APRES le mot de
        // passe (pour ne pas laisser un appelant non authentifie deviner
        // qu'un compte existe et est suspendu juste en essayant l'email).
        if (Boolean.FALSE.equals(utilisateur.getActif())) {
            throw new CompteSuspenduException(
                    "Ce compte a ete suspendu par un administrateur. Contactez le support pour plus d'informations.");
        }
